...
<body>
        ...
        <div class="h-full px-3 pb-4 overflow-y-auto bg-primaryColor">
            <ul class="space-y-2 mt-10 font-medium">
                <li>
                    ...
                    hover:text-black hover:bg-secondaryColor group"><svg
                ...
                <li>
                    <a href="/admin/tentang-kami"
                        class="flex items-center p-2 rounded-lg {{ request()->is('admin/tentang-kami') ? 'bg-secondaryColor text-black' : 'text-white' }}
                    hover:text-black hover:bg-secondaryColor group">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round"
                ...
                <li>
                    <a href="/admin/kesiswaan"
                        class="flex items-center p-2 rounded-lg {{ request()->is('admin/kesiswaan') ? 'bg-secondaryColor text-black' : 'text-white' }}
                    hover:text-black hover:bg-secondaryColor group">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                            stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-friends">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            const isActiveProgramKeahlian = {!! json_encode(request()->is('admin/program-keahlian')) !!};
            const isActiveJadwal = {!! json_encode(request()->is('admin/jadwal')) !!};
            const isActiveBerita = {!! json_encode(request()->is('admin/berita')) !!};
            const isActivePrestasi = {!! json_encode(request()->is('admin/prestasi')) !!};
            const isActiveTentangKami = {!! json_encode(request()->is('admin/tentang-kami')) !!};
            const isActiveKesiswaan = {!! json_encode(request()->is('admin/kesiswaan')) !!};
            const isActiveStrukturOrganisasi = {!! json_encode(request()->is('admin/struktur-organisasi')) !!};
            const isActiveDaftarGuru = {!! json_encode(request()->is('admin/daftar-guru')) !!};
        });
    </script>
</body>
