            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center justify-start rtl:justify-end">
                    ...
                    <div class="flex ms-2 md:me-24">
                        ...
                        <span
                            class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap text-white">SMKN 1 Pedan
                        </span>
                    </div>
                </div>
                <div class="flex items-center">
                    <div class="flex items-center ms-3 relative">
                        <button type="button" id="dropdown-toggle"
                            class="flex text-sm bg-primaryColor rounded-full focus:ring-4 focus:ring-gray-600"
                            aria-expanded="false">
                            <span class="sr-only">Open user menu</span>
                            <img class="w-10 h-10 rounded-full"
                                src="https://flowbite.com/docs/images/people/profile-picture-5.jpg" alt="user photo">
                        </button>
                        <div class="z-50 hidden my-4 w-36 text-base list-none divide-y rounded shadow bg-gray-700 divide-gray-600 absolute top-full left-1/2 transform -translate-x-32"
                            id="dropdown-user">
                            ...
                            <ul class="py-1" role="none">
                                <li>
                                    <a href="#"
                                        class="block px-4 py-2 text-sm text-white hover:bg-gray-600 hover:text-white"
            ...
            <ul class="space-y-2 mt-10 font-medium">
                ...
                <li>
                    <a href="#" class="flex items-center p-2 rounded-lg text-white hover:bg-gray-700 group">
                        ...
                        <span
                            class="inline-flex items-center justify-center px-2 ms-3 text-sm font-medium rounded-full bg-gray-700 text-gray-300">Pro</span>
                    </a>
                </li>
                <li>
                    <a href="#" class="flex items-center p-2 rounded-lg text-white  hover:bg-gray-700 group">
