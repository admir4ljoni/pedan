...
<body>
        ...
        <div class="px-3 py-2 lg:px-5 lg:pl-3">
            <div class="flex items-center justify-between">
                <div class="flex items-center justify-start rtl:justify-end">
                    <button data-drawer-target="logo-sidebar" data-drawer-toggle="logo-sidebar" aria-controls="logo-sidebar" type="button" class="inline-flex items-center p-2 text-sm rounded-lg sm:hidden focus:outline-none focus:ring-2 text-gray-400">
                ...
                <div class="flex items-center">
                    <div class="flex items-center ms-3 relative">
                        <button type="button" id="dropdown-toggle" class="flex text-sm bg-primaryColor rounded-full focus:ring-2 focus:ring-secondaryColor" aria-expanded="false">
                            <span class="sr-only">Open user menu</span>
                            <svg xmlns="http://www.w3.org/2000/svg" width="42" height="42" viewBox="0 0 24 24" fill="none" stroke="#ffff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-user-circle">
                        ...
                        <div class="z-50 hidden my-4 w-36 text-base list-none divide-y rounded shadow bg-secondaryColor absolute top-full left-1/2 transform -translate-x-32" id="dropdown-user">
                            ...
                            <ul class="py-1" role="none">
                                <li>
                                    <a href="#" class="block px-4 py-2 text-base text-black font-semibold hover:bg-white" role="menuitem">Log out</a>
                                </li>
                            </ul>
                        </div>
                    </div>
    ...
    <aside id="logo-sidebar" class="fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full border-r sm:translate-x-0 bg-primaryColor border-gray-700" aria-label="Sidebar">
        <div class="h-full px-3 pb-4 overflow-y-auto bg-primaryColor">
            <ul class="space-y-2 mt-10 font-medium">
                <li>
                    ...
                    hover:text-black hover:bg-secondaryColor group"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-books">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                ...
                <li>
                    ...
                    hover:text-black hover:bg-secondaryColor group">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-pencil-check">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
