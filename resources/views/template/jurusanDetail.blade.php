...
@section('content')
    ...
    <div class="mx-12 md:mx-16 mt-12 md:mt-20 ">
        <h1 class="uppercase font-black text-2xl md:text-3xl text-center mb-14 text-primaryColor"> @yield('namaJurusan')
        </h1>
        <div class="flex flex-col md:flex-row gap-8 justify-start mt-20 mb-20">
            ...
            <h3 class="text-xl font-bold mt-1">@yield('deskripsiJurusan')</h3>
        </div>
