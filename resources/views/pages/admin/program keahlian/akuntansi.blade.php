...
<div class="">
    <div class="">
        ...
        <x-modal title="UBAH DATA PROFIL JURUSAN" id="modalEditProfil"
            aksi="{{route('admin-jurusan-update', ['jurusan' => '1'])}}" method="POST">
            <x-slot name="token">
                @csrf
            </x-slot>
        ...
        {{-- modal tambah foto --}}
        <x-modal title="TAMBAH FOTO" id="modalTambahFoto" aksi="{{route('admin-jurusan-update', ['jurusan' => '1'])}}"
            method="POST">
            <x-slot name="token">
                @csrf
            </x-slot>
        ...
        {{-- modal hapus foto --}}
        <x-alertHapus aksi="{{ route('admin-jurusan-delete', ['jurusan' => '1']) }}" />
