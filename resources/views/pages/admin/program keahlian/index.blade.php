...
@section('content')
    ...
    <div class="mt-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 gap-10">
        <div
            ...
            <a href="/admin/program-keahlian/akuntansi">
        ...
        <div
            class="flex justify-center items-center border border-gray-300 w-72 h-52 rounded-lg shadow-md hover:bg-gray-100">
            <a href="/admin/program-keahlian/menajemen-perkantoran">
                <div class="flex flex-col items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" width="56" height="56" viewBox="0 0 24 24" fill="none"
                        stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
        ...
        <div
            class="flex justify-center items-center border border-gray-300 w-72 h-52 rounded-lg shadow-md hover:bg-gray-100">
            <a href="/admin/program-keahlian/perangkat-lunak">
                <div class="flex flex-col items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" width="56" height="56" viewBox="0 0 24 24" fill="none"
                        stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
        ...
        <div
            class="flex justify-center items-center border border-gray-300 w-72 h-52 rounded-lg shadow-md hover:bg-gray-100">
            <a href="/admin/program-keahlian/teknik-komputer-jaringan">
                <div class="flex flex-col items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" width="56" height="56" viewBox="0 0 24 24" fill="none"
                        stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
        ...
        <div
            class="flex justify-center items-center border border-gray-300 w-72 h-52 rounded-lg shadow-md hover:bg-gray-100">
            <a href="/admin/program-keahlian/broadcasting">
                <div class="flex flex-col items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" width="56" height="56" viewBox="0 0 24 24" fill="none"
                        stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
        ...
        <div
            class="flex justify-center items-center border border-gray-300 w-72 h-52 rounded-lg shadow-md hover:bg-gray-100">
            <a href="/admin/program-keahlian/pemasaran">
                <div class="flex flex-col items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" width="56" height="56" viewBox="0 0 24 24" fill="none"
                        stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
