...
@section('title', 'Admin - Manajemen Perkantoran ')

@section('content')
<div class="">
    <div class="">
        <h2 class="text-2xl font-extrabold uppercase mb-14">Manajemen Perkantoran</h2>
        {{-- modal ubah data profil jurusan --}}
        <x-modal title="UBAH DATA PROFIL JURUSAN" id="modalEditProfil"
            aksi="{{route('admin-jurusan-update', ['jurusan' => '2'])}}" method="POST">
            <x-slot name="token">
                @csrf
            </x-slot>
        ...
        {{-- modal tambah foto --}}
        <x-modal title="TAMBAH FOTO" id="modalTambahFoto" aksi="{{route('admin-jurusan-update', ['jurusan' => '2'])}}"
            method="POST">
            <x-slot name="token">
                @csrf
            </x-slot>
        ...
        {{-- modal hapus foto --}}
        <x-alertHapus aksi="{{ route('admin-jurusan-delete', ['jurusan' => '2']) }}" />
    ...
    <div class="mb-14">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5">
            @forelse($data->where('jurusan_id', 2) as $gambar)
