...
@section('content')
    <div class="">
        <div class="">
            ...
            <x-modal title="UBAH DATA SAMBUTAN KEPALA SEKOLAH" id="modalEditSambutan">
                <x-slot name="content">
                    <div class="mb-10">
                        <x-input id="foto" name="foto" type="file" title="Upload Foto" />
                        <x-input id="nama" name="nama" type="text" title="Nama Kepala Sekolah" />
                        <div class="mt-5">
            ...
            <x-modal title="UBAH DATA VISI SEKOLAH" id="modalEditVisi">
                <x-slot name="content">
                    <div class="mb-10">
                        <x-input id="fotoVisi" name="fotoVisi" type="file" title="Upload Foto" />
                        <div class="mt-5">
                            <label for="messageVisi" class="block text-base font-semibold leading-6 text-gray-900">Visi Sekolah</label>
                            <textarea id="messageVisi" rows="4"
                                class="block p-2.5 w-full text-sm text-gray-900 bg-white rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500"
                                placeholder="Tuliskan Visi Sekolah Disini"></textarea>
                        </div>
                    </div>
                </x-slot>
            </x-modal>
            ...
            <x-modal title="UBAH DATA MISI SEKOLAH" id="modalEditMisi">
                <x-slot name="content">
                    <div class="mb-10">
                        <x-input id="fotoMisi" name="fotoMisi" type="file" title="Upload Foto" />
                        <div class="mt-5">
                            <label for="messageMisi"
                                class="block text-base font-semibold leading-6 text-gray-900">Misi</label>
                            <textarea id="messageMisi" rows="4"
                                class="block p-2.5 w-full text-sm text-gray-900 bg-white rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500"
