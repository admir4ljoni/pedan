        ...
        <x-slot name="content">
            <div class="mb-10">
                ...
                <div class="mt-5">
                    ...
                    <select name="mapel_id" id="category"
        ...
        <x-slot name="content">
            ...
            <div class="mb-10">
                ...
                <div class="mt-5">
                    <label for="category" class="block text-base font-semibold leading-6 text-gray-900 mb-2">Guru
                        Mapel</label>
                    <select id="editCategory" name="editMapel_id"
                        class="text-sm p-3 rounded-lg block w-full bg-gray-100 border-gray-500 placeholder-gray-400 text-black">
                ...
                <x-slot name="icon">
                    <span class="text-gray-500 hover:text-gray-800">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                            ...
                            class="icon icon-tabler icons-tabler-outline icon-tabler-edit" data-id="{{ $pendidik->id }}">
                    ...
                    <span class="text-gray-500 hover:text-gray-800">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none"
                            ...
                            class="icon icon-tabler icons-tabler-outline icon-tabler-trash" data-id="{{ $pendidik->id }}">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                            <path d="M4 7l16 0" />
                            <path d="M10 11l0 6" />
                            <path d="M14 11l0 6" />
