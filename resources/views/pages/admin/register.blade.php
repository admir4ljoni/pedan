    ...
    <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
        ...
        <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
            <form class="space-y-6" action="{{route('register')}}" method="POST">
                ...
                <div>
                    <button type="submit"
                        class="flex w-full justify-center rounded-md bg-primaryColor hover:bg-blue-900 px-3 py-3 text-base font-semibold leading-6 text-white shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 ">REGISTER</button>
                </div>
            </form>
            <p class="mt-10 text-center text-md text-gray-500">
                Sudah memiliki Akun?
                <a href="/admin" class="font-semibold text-md leading-6 text-primaryColor">Login</a>
            </p>
        </div>
    </div>
