        ...
        @forelse ($data as $star)
            <div class="hidden duration-700 ease-in-out relative" data-carousel-item>
                <div class="absolute block w-full -translate-x-1/2 left-1/2">
                    <img src="{{Storage::url('public/storages/berita/' . $star->gambar)}}"
                ...
                <div class="absolute top-0 mt-16 md:mt-80 ml-20 md:ml-28 z-0 ">
                    <h1 class="font-bold text-white text-xl md:text-3xl uppercase mr-16 md:mr-28">{{$star->judul}}</h1>
                </div>
            </div>
        @empty
            <div class="hidden duration-700 ease-in-out relative" data-carousel-item>
                ...
                <div class="absolute top-0 mt-16 md:mt-80 ml-20 md:ml-28 z-0 ">
                    ...
                    <h2 id="limited-text" class="font-medium text-white text-base md:text-2xl capitalize mr-16 md:mr-28">
            ...
            <div class="hidden duration-700 ease-in-out relative" data-carousel-item>
                ...
                <div class="absolute top-0 mt-16 md:mt-80 ml-20 md:ml-28 z-0 ">
                    <h1 class="font-bold text-white text-xl md:text-3xl uppercase mr-16 md:mr-28">Seminar Membangun Budaya
                        Displin </h1>
                    <h2 id="limited-text" class="font-medium text-white text-base md:text-2xl capitalize mr-16 md:mr-28">
...
<div class="mx-12 md:mx-16">
    <div class="mx-4">
        <a href="https://wa.me/6281390756573" class="fixed bottom-10 right-10 z-50">
        ...
        <h1 class="font-black text-2xl md:text-3xl mt-20 text-center uppercase mb-10 md:mb-20 text-primaryColor"
            data-aos="fade-right" data-aos-duration="1500">program
            keahlian kurikulum merdeka
        </h1>
        <div class="flex flex-wrap gap-5 justify-center" data-aos="fade-down" data-aos-duration="1500">
    ...
    <div class="mt-20 ">
        <h1 class="font-black text-2xl md:text-3xl mt-20 text-center uppercase mb-10 text-primaryColor"
            data-aos="fade-right" data-aos-duration="1500"> Informasi data sekolah
        </h1>
        <div class="flex flex-wrap justify-center mb-40 mt-20" data-aos="fade-left" data-aos-duration="1000">
    ...
    <div class="px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
        <h1 class="font-black text-2xl md:text-3xl mt-20 text-center uppercase mb-10 md:mb-20 text-primaryColor"
            data-aos="fade-right" data-aos-duration="1500">Berita dan Informasi Sekolah
        </h1>
        <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-6" data-aos="fade-left" data-aos-duration="1000">
            ...
            @empty
                <x-berita title="Lorem ipsum dolor sit amet consectetur adipisicing elit. Consequuntur, voluptatum."
                    date="September 12, 2022" image="/assets/lksss.jpeg" />
                <x-berita title="Lorem ipsum dolor sit amet consectetur adipisicing elit. Consequuntur, voluptatum."
                    date="September 12, 2022" image="/assets/batikk.jpg" />
                <x-berita title="Lorem ipsum dolor sit amet consectetur adipisicing elit. Consequuntur, voluptatum."
                    date="September 12, 2022" image="/assets/lksss.jpeg" />
                <x-berita title="Lorem ipsum dolor sit amet consectetur adipisicing elit. Consequuntur, voluptatum."
                    date="September 12, 2022" image="/assets/batikk.jpg" />
