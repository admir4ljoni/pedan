...
@section('content')
    ...
    <div class="mx-12 md:mx-16 mt-12 md:mt-20 ">
        <h1 class="uppercase font-black text-2xl md:text-3xl text-center mb-14 text-primaryColor" data-aos="fade-down" data-aos-duration="1000">visi misi smk negeri 1
            pedan</h1>
        ...
        <div class="flex flex-col md:flex-row gap-8 justify-end mt-20">
            ...
            {{-- image & background --}}
            <div class="relative mr-auto ml-auto md:mr-7 md:ml-0 mb-10 order-1 md:order-2" data-aos="fade-left" data-aos-duration="2000">
                <div
                    class="bg-secondaryColor h-64 w-56 md:h-96 md:w-80 translate-x-5 translate-y-6 rounded-lg overflow-hidden">
                </div>
                <img src="/assets/batikk.jpg" alt="visi misi"
