<footer class="relative z-10 bg-primaryColor pt-20 pb-10 px-16">
    <div class="container mx-auto">
        <div class="flex flex-wrap -mx-4">
            <div class="w-full px-4 sm:w-2/3 lg:w-3/12">
                <div class="w-full mb-10">
                    <a href="/" class="mb-6 inline-block w-32 ">
                        <img src="{{ asset('assets/logo smk pedan.png') }}" alt="logo" class="max-w-full" />
                    </a>
                    <p class="text-sm md:text-lg font-medium text-white mb-7">
                        Jl. Raya Pedan, Polaharjo, Sobayan, Kec. Pedan, Kabupaten Klaten, Jawa Tengah 57468
                    </p>
                    <p class="flex items-center text-sm font-medium text-white">
                        ...
                        <span class="text-sm md:text-md">0272 - 897237</span>
                    </p>
                </div>
            </div>
            ...
            <div class="w-full px-4 sm:w-1/2 lg:w-3/12">
                <div class="w-full mb-10">
                    ...
                    <div class="flex items-center mb-6">
                        <a href="https://web.facebook.com/kadansajaya?_rdc=1&_rdr"
                    ...
                    <p class="text-sm md:text-lg text-white">
                        &copy; 2024 SMK Negeri 1 Pedan. All Rights Reserved
                    </p>
                </div>
            </div>
        </div>
